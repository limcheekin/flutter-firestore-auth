  ...
  Future<void> loginUser() async {
    ...
    if (!form.validate()) {
      ...
      try {
        ...
        print('onval ${userCredential.user}');
  ...
  Future<String> signInWithGoogle() async {
    try {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (BuildContext context) =>
              Chat(userData: userCredential.user.email),
        ),
      );

      return 'signInWithGoogle succeeded: $userCredential';
    } catch (error) {
      print('error............ $error');
    }
  }
  ...
  Widget build(BuildContext context) {
    Widget emailForm = Container(
      ...
      child: Row(
        children: <Widget>[
          Image.asset(
            "lib/assets/icons/user-grey.png",
            height: 16.0,
            width: 16.0,
          ),
          Container(
      ...
      decoration: new BoxDecoration(
        border: new Border(
          bottom: BorderSide(
              color: _getBorderColor(), style: BorderStyle.solid, width: 2.0),
        ),
      ),
    );
    ...
    Widget passwordForm = Container(
      ...
      child: Row(
        children: <Widget>[
          Image.asset(
            "lib/assets/icons/lock-grey.png",
            height: 16.0,
            width: 16.0,
          ),
          Container(
          ...
          InkWell(
              ...
              child: showText
                  ? Image.asset(
                      "lib/assets/icons/show-grey.png",
                      height: 16.0,
                      width: 16.0,
                    )
                  : Image.asset(
                      "lib/assets/icons/show.png",
                      height: 16.0,
                      width: 16.0,
                    )),
        ],
      ...
      decoration: new BoxDecoration(
        border: new Border(
          bottom: BorderSide(
              color: _getBorderColor2(), style: BorderStyle.solid, width: 2.0),
        ),
      ),
    );
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  padding: EdgeInsets.only(
                      left: 16.0, top: 28.0, bottom: 4.0, right: 16.0),
                  child: Column(
