...
class HalfRoundButton extends StatefulWidget {
  ...
  HalfRoundButton({Key key, this.title, this.color1, this.color2, this.left})
      : super(key: key);
  @override
...
class RoundButton extends StatefulWidget {
  ...
  RoundButton({Key key, this.title, this.color1, this.color2})
      : super(key: key);
  @override
